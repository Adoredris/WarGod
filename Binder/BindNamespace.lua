Binder = LibStub("AceAddon-3.0"):NewAddon("WarGodBinder", "AceConsole-3.0", "AceEvent-3.0")
...
Binder.GetSpellInfo = GetSpellInfo
...
--Binder.Auras = LibStub("AceAddon-3.0"):NewAddon("SkyAuras", "AceConsole-3.0", "AceEvent-3.0")
--Sky.Auras = Auras
