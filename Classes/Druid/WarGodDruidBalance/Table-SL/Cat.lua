...
do
    ...
    AddSpellFunction("Balance","Rip",baseScore + 60,{
    ...
    AddSpellFunction("Balance","Ferocious Bite",baseScore + 50,{
    ...
    AddSpellFunction("Balance","Rake",baseScore + 20,{
    ...
    AddSpellFunction("Balance","Shred",baseScore + 10,{
        func = function(self) return player.energy >= 80 or player.combopoints < 5 end,
        units = groups.targetable,
