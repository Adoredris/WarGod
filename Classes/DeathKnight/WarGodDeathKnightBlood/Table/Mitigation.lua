...
do
    ...
    AddSpellFunction("Blood","Ironfur",baseScore + 130,{
    ...
    AddSpellFunction("Blood","Ironfur",baseScore + 125,{
    ...
    AddSpellFunction("Blood","Ironfur",baseScore + 120,{
    ...
    AddSpellFunction("Blood","Ironfur",baseScore + 110,{
        func = function(self) return player.rage >= 40 and buff.ironfur:Remains() < 1 and TankingSomething() and
                buff.Blood_of_elune:Stacks() >= 1 and buff.Blood_of_elune:Remains() < 1 end,
        units = groups.noone,
        label = "Ironfur Longer Buff Expiring Soon",
    })

    AddSpellFunction("Blood","Ironfur",baseScore + 100,{
    ...
    AddSpellFunction("Blood","Frenzied Regeneration",baseScore + 230,{
    ...
    AddSpellFunction("Blood","Frenzied Regeneration",baseScore + 220,{
