...
local bossString = "Assault of the Zaqali"
WGBM[bossString] = {}
...
WGBM[bossString].Priority = function(spell, unit, args)
    ...
    if name == "Warlord Kagni" then
        score = 20
    elseif name == "Magma Mystic" and (UnitCastingInfo(unitid) == "Molten Barrier" or unit:BuffRemaining("Molten Barrier","HELPFUL") ~= 0) then
        score = 30
    end
