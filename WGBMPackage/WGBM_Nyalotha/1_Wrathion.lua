...
local bossString = "Wrathion, the Black Emperor"      -- not right at all
WGBM[bossString] = {}
...
WGBM[bossString].DPSBlacklist = function(spell, unit, args)
    ...
    if UnitIsUnit(unitid, "boss1") and UnitBuff("boss1", 1) == "Smoke and Mirrors" then
        return true
    elseif name == "Ashwalker Assassin" then
        return true
    end
end
